package com.example.twttheory.cache
...
fun <V : Any> Cache.Companion.from(generator: () -> Deferred<V>): Cache<V> =
    object : ReadOnlyCache<V> {
        override fun get(): Deferred<V?> = generator()
    }

fun <V : Any> Cache.Companion.retrofit(generator: () -> Call<V>): Cache<V> =
    object : ReadOnlyCache<V> {
